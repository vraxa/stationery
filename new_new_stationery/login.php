...
<div class="login-page">
  <div class="login-card">
    <img src="assets/logo_not_aids.png" alt="Logo">
    <p>Stationery Ordering System</p>
    ...
    <?php if ($devMode): ?>
    <div class="login-divider">DEV MODE PLEASE TURN THIS OFF LOL</div>

    <div class="dev-panel">
      <div class="dev-panel-title">dev login for cool kids</div>
      <form method="post" action="api/dev-login.php">
        <input type="text"  name="name"  placeholder="Display name" required value="lebron james">
