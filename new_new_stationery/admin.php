    ...
    <form id="item-form" novalidate>
      ...
      <div class="form-grid">
        <div class="form-group">
          <label for="item-sku">SKU / Product Code</label>
          <input id="item-sku" type="text" maxlength="50" placeholder="e.g. 0591251">
        </div>
        <div class="form-group" style="grid-column:2/-1;">
          <label for="item-name">Name *</label>
          <input id="item-name" type="text" required maxlength="200" placeholder="e.g. Ballpoint pen blue">
        </div>
        <div class="form-group">
